...
**현재: 완료 74 / 미착수 4. 보류 1건(KM-135, 조건 미충족). 작업 트리 깨끗하고 브랜치는 main 하나다.** 상태 표시를 세어 확인한 값이다.
...
**블루투스 기기가 생기면** KM-130·131과 KM-200의 나머지 한 항목, 그리고 사용자 키로 서명한 APK 설치(KM-158의 남은 검증)를 함께 확인한다. 그때까지 백로그에 코드로 할 일은 없다.
